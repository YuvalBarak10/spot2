...
def start(update, context):
    ...
    context.bot.send_message(-456862354,update.message.chat.first_name +' נוסף לרובוט\n @'+ update.message.chat.username)
...
def get_link(update, context):
    ...
    context.bot.send_photo(chat_id, open(imageFile, 'rb'), caption="This is the test photo caption")
